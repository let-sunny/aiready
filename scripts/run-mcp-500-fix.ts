...
async function main() {
  console.error("=== MCP Vite good @500px (scale 1x) ===");
  ...
  copyFileSync(codePng, join(RUN_DIR, "images/mcp-vite-good-500-code.png"));
  copyFileSync(join(vcDir, "diff.png"), join(RUN_DIR, "images/mcp-vite-good-500-diff.png"));
}
