...
async function main() {
  console.error("=== MCP Vite good (ALL 375 removed) @500px ===");
  const port = 4480;
  ...
  const vcDir = join(RUN_DIR, "vc-mcp-good-all375-removed-500");
  ...
  copyFileSync(codePng, join(RUN_DIR, "images/mcp-good-all375-removed-500-code.png"));
  copyFileSync(join(vcDir, "diff.png"), join(RUN_DIR, "images/mcp-good-all375-removed-500-diff.png"));
}
